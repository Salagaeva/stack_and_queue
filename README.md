...
|![queue](./pictures/.png)| - указатель на последний добавленный в очередь элемент|
|![stack](./pictures/.png)| - указатель на последний вошедший элемент в стек, а  - на первый вошедший элемент|
|![queue](./pictures/.png)| - указатель на последний вошедший элемент в очередь, а  - на первый вошедший элемент|
